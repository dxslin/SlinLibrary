...
object Versions {
    ...
    const val slin_library_version = "1.1.0"
    ...
    const val sceneform_version = "1.16.0"

    const val filament_version = "1.9.9"
...
//    const val view_pager_indicator = "com.github.dxslin.SlinLibrary:ViewPagerIndicator:${Versions.slin_library_version}"
    ...
    //sceneform -- load 3d model
    const val sceneform_core = "com.google.ar.sceneform:core:${Versions.sceneform_version}"
    const val sceneform_ux = "com.google.ar.sceneform.ux:sceneform-ux:${Versions.sceneform_version}"
    const val sceneform_assets = "com.google.ar.sceneform:assets:${Versions.sceneform_version}" //load from assets

    const val filament_android = "com.google.android.filament:filament-android:${Versions.filament_version}"
    const val gltfio_android = "com.google.android.filament:gltfio-android:${Versions.filament_version}"
    const val filament_utils_android = "com.google.android.filament:filament-utils-android:${Versions.filament_version}"
